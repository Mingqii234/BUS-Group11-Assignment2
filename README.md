...
|    Mingqi Pan - 2749735               |       20%           |Implemented `energy_data.py` for energy data generation using a factory pattern;<br> Developed `visualizer.py` for plotting energy usage trends with Matplotlib;<br>Demonstrated the energy alert and visualization tests in the project video;<br>Contributed the functionality summary section in the README.                                   |                   | Mingqi Pan |
